    ...
    return (
        <>
            <div className=" flex-1 h-full flex flex-col gap-5">
                <div className="flex flex-col md:flex-row md:flex-wrap h-[456px] gap-5">
                    <div className="w-full lg:w-[381px] h-full bg-secondary-400 rounded-xl p-4">
                        <TeamLeader />
                    </div>
                    <div className="w-full flex-1 h-full bg-secondary-400 min-w-[400px] rounded-xl p-4">
                        <NewTournaments />
                    </div>
                    <div className="w-full lg:w-[381px] h-full bg-secondary-400 rounded-xl p-4">
                        <TopPlayers />
