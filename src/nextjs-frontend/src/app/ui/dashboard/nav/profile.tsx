...
export const ProfileIcon = () => {
    ...
    return (
        <button className="profile-button flex  flex-row items-center justify-between rounded-md overflow-hidden bg-[#303030] p-1 h-[46.9] min-w-40 "
            ...
            <div className="flex items-center">
                ...
                <div className="flex flex-col max-w-[80px]">
                    <div className="font-medium text-white truncate ">aaitounaaaaaaaaa</div>
