			...
			<div className='h-full'>
				<div className='flex-1 h-full flex flex-row flex-wrap gap-5'>
					<div className='grid-container gap-4'>
						<div className='bg-secondary-400 rounded-xl p-4  item-a'>
							<TeamLeader />
						</div>
						<div className='bg-secondary-400 rounded-xl p-4  item-b'>
							<NewTournaments />
						</div>
						<div className='bg-secondary-400 rounded-xl p-4  item-c'>
							<TopPlayers />
						</div>
					</div>
					...
					<div className='grid-container gap-4'>
						...
						<div className='item-b h-[456px] flex-1 bg-secondary-400 rounded-xl p-4'>
							<Tournaments />
						</div>
