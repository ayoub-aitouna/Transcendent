		...
		<div className=''>
			<div className="flex flex-row items-center justify-between relative">
				...
				<div className={`pl-3 flex flex-row items-end justify-end gap-2`} >
					<Link href="/messenger/New-group">					<svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
