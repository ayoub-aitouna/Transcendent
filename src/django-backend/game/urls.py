...
urlpatterns = [
    ...
    path('private-tournaments/', view=views.privateTournamentslist.as_view(), name='private-tournament'),
    path('announcements/', view=views.listTournaments.as_view(), name='announcements'),
