    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ManyToManyField(blank=True, to='user.achievements')),
                ('rank', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_rank', to='user.ranks')),
                ('ranking_logs', models.ManyToManyField(to='user.ranks')),
            ],
            options={
                'verbose_name': 'user',
